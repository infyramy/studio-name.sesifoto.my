...
export const translationsBM: Translations = {
  ...
  selectThemeDescription:
    "Sila pilih konsep yang anda inginkan untuk sesi anda.",
  change: "Tukar",
  ...
  balanceAtStudio: "Baki bayar setelah selesai",
  pay: "Bayar",
  ...
  balancePayAtStudio: "Baki (bayar setelah selesai)",
  amountToPayExplanation:
    "Baki pembayaran boleh dibayar setelah selesai.",
...
export const translationsEN: Translations = {
  ...
  selectThemeDescription: "Select the theme that suits you.",
  ...
  balanceAtStudio: "Balance to pay after session",
  pay: "Pay",
  ...
  balancePayAtStudio: "Balance (pay after session)",
  amountToPayExplanation:
    "Balance amount can be paid after session.",
