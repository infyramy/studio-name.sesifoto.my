...
export const translationsBM: Translations = {
  ...
  reserveSlotMessage: 'Anda akan mempunyai 10 minit untuk melengkapkan tempahan anda.',
  ...
  reservationExpiredMessage: 'Tempahan anda telah tamat tempoh. Sila pilih slot masa baharu.',
  slotNoLongerAvailable: 'Slot Tidak Tersedia',
  slotNoLongerAvailableMessage: 'Slot ini baru sahaja ditempah oleh pelanggan lain. Sila pilih slot lain.',
  slotBeingBooked: 'Slot Sedang Ditempah',
  slotBeingBookedMessage: 'Slot ini sedang ditempah oleh pelanggan lain. Cuba lagi dalam beberapa minit.',
  changeTime: 'Tukar Masa',
  changeSlot: 'Tukar Slot',
  changeSlotConfirm: 'Tukar Slot Masa?',
  changeSlotMessage: 'Menukar masa akan melepaskan tempahan semasa anda. Teruskan?',
  goingBackWillRelease: 'Ke Belakang Akan Melepaskan Tempahan',
  goingBackMessage: 'Kembali akan melepaskan tempahan slot masa semasa anda. Teruskan?',
  restoreYourBooking: 'Pulihkan Tempahan Anda?',
  restoreBookingMessage: 'Kami menjumpai tempahan anda dari beberapa minit yang lalu. Mahu teruskan dari mana anda berhenti?',
  startFresh: 'Mula Baharu',
  reserving: 'Menempah...',
  reserved: 'Ditempah',
  minutesRemaining: 'minit berbaki',
  itemExpiredRemoved: 'Slot masa telah tamat tempoh dan telah dikeluarkan dari troli.',
  failedToAddToCart: 'Gagal menambah ke troli. Slot mungkin tidak tersedia lagi.',
...
export const translationsEN: Translations = {
  ...
  reservationExpiredMessage: 'Your reservation has expired. Please select a new time slot.',
  slotNoLongerAvailable: 'Slot No Longer Available',
  slotNoLongerAvailableMessage: 'This slot was just booked by another customer. Please select another time.',
  slotBeingBooked: 'Slot Being Booked',
  slotBeingBookedMessage: 'This slot is currently being booked by another customer. Try again in a few minutes.',
  changeTime: 'Change Time',
  changeSlot: 'Change Slot',
  changeSlotConfirm: 'Change Time Slot?',
  changeSlotMessage: 'Changing time will release your current reservation. Continue?',
  goingBackWillRelease: 'Going Back Will Release Hold',
  goingBackMessage: 'Going back will release your current time slot reservation. Continue?',
  restoreYourBooking: 'Restore Your Booking?',
  restoreBookingMessage: 'We found your booking from a few minutes ago. Would you like to continue where you left off?',
