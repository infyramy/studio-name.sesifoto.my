  ...
  <div :class="['min-h-full', surfaceClass]">
    ...
    >
      ...
      <section
        ...
        class="grid gap-1 px-3 pb-10 sm:grid-cols-2 md:px-4"
      >
        <img
      ...
      <section
        ...
        class="px-4 pb-14 md:px-8"
      >
        <div class="border border-[var(--border-color)] px-5 py-8 md:px-8 md:py-10">
          <div class="mb-5 flex gap-1" aria-hidden="true">
            <span
              v-for="n in 8"
              :key="n"
          ...
          <p class="font-title text-2xl leading-snug tracking-tight text-[var(--text-main)] md:text-3xl">
      ...
      <section
        ...
        class="space-y-0 px-4 pb-14 md:px-8"
      >
        <article
