    ...
    <div class="relative z-20">
      ...
      <main class="p-6 sm:p-8 max-w-4xl mx-auto space-y-8 pb-32">
        ...
        <div v-if="currentStep === 2" class="space-y-10 animate-fade-in">
          ...
          <div class="flex flex-col space-y-4">
            <div
              class="flex gap-3 overflow-x-auto pb-4 pt-2 px-1 scrollbar-hide snap-x mask-fade"
            >
              <button
                v-for="d in dates"
                :key="d.date"
            ...
            <div
              v-if="isSpecialDateSelected"
              class="bg-amber-50/80 backdrop-blur-sm border border-amber-100/50 p-4 rounded-2xl flex items-center gap-3 text-amber-900 shadow-sm"
            >
              ...
              <div class="text-xs font-sans leading-relaxed">
                <span
                  class="font-bold block uppercase tracking-wider text-[10px] mb-0.5 text-amber-700"
                  >Tarikh Istimewa</span
                >
          ...
          >
            <div class="flex items-center justify-between">
              ...
              <span
                ...
                >{{ selectedSlot ? "1 Masa Dipilih" : "Pilih 1 Slot" }}</span
              >
            </div>
              ...
              <div>
                ...
                <p class="text-sm text-gray-500 font-sans mt-1">
                  ...
                  <span class="font-medium text-gray-900"
                    >{{ selectedTheme?.base_pax }} orang</span
                  >
                </p>
              </div>
              <div
          ...
          <div class="space-y-4">
            ...
            >
              <div>
                ...
                <div class="text-sm text-gray-500 font-sans mt-0.5">
              ...
              <div
                v-else
                class="flex items-center gap-4 bg-gray-50 rounded-full p-1 border border-gray-200/50"
              >
                <button
                ...
                <span class="font-serif font-bold w-4 text-center">{{
          ...
          <div class="space-y-6">
            ...
            >
              <div class="relative group">
                ...
                <label
                  for="name"
                  class="absolute left-0 -top-1 text-xs font-bold uppercase tracking-wider text-gray-500 transition-all peer-placeholder-shown:top-4 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-placeholder-shown:font-normal peer-placeholder-shown:normal-case peer-focus:-top-1 peer-focus:text-xs peer-focus:text-gray-900 peer-focus:font-bold peer-focus:uppercase"
                >
                  Nama Penuh
                </label>
              </div>
      ...
      <div class="fixed bottom-0 left-0 right-0 pb-2 z-50 pointer-events-none">
        <div class="max-w-4xl mx-auto px-4 pb-6 safe-area-bottom">
          <div
            class="bg-white/80 backdrop-blur-md border border-white/40 p-4 rounded-3xl shadow-2xl shadow-black/5 flex items-center justify-between gap-4 pointer-events-auto"
          >
            <div class="flex flex-col pl-2">
              ...
              <span class="font-bold font-serif text-2xl text-gray-900">
                RM{{
                  currentStep === 4
                    ? formatPriceWhole(cartTotal)
                    : formatPriceWhole(currentItemTotal)
                }}
              </span>
            </div>
            <button
